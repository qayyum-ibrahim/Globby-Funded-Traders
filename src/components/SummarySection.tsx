        ...
        <div className="animate-fade-in">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <p className="text-xl md:text-2xl leading-relaxed mb-8 opacity-90">
              We are a firm that actually wants you to make money from the
              market and not the other way round. You're trading live capital,
              so when you profit, we profit — when you lose, we lose. That's why
              we back only real traders.
            </p>
          </div>
